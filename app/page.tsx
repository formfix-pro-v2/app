...
export default function HomePage() {
  ...
  const pillars = [
    { title: t("home.pillar1"), desc: t("home.pillar1Desc") },
    { title: t("home.pillar2"), desc: t("home.pillar2Desc") },
    { title: t("home.pillar3"), desc: t("home.pillar3Desc") },
  ];
  ...
  return (
    <main className="relative min-h-screen bg-transparent">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <h1 className="text-5xl md:text-[62px] leading-[1.05] text-[#4a3f44] tracking-tight">
              {t("home.title1")}
              <br />
              <span className="italic font-light text-[#d8a7b5]">{t("home.title2")}</span>
              <br />
              {t("home.title3")}
            </h1>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/quiz" className="btn-primary">{t("home.cta")}</Link>
            <Link href="/pricing" className="btn-outline">{t("home.viewPlans")}</Link>
          </div>
          ...
          <div className="flex items-center gap-2 pt-2 opacity-80">
            ...
            <p className="text-[11px] italic text-[#7b6870]">{t("home.trusted")}</p>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-8">
        <h2 className="text-4xl text-center mb-6 text-[#4a3f44] tracking-tight italic">{t("home.signatureTitle")}</h2>
      ...
      {/* TESTIMONIALS */}
      <section className="max-w-7xl mx-auto px-6 py-8">
        <h2 className="text-4xl text-center mb-8 text-[#4a3f44] tracking-tight italic">Real Women, Real Results</h2>
        <div className="grid md:grid-cols-3 gap-4">
          {[
            ...
            <div key={t.name} className="soft-card p-6 hover:scale-[1.02] transition-transform">
              <p className="text-[#6f5a62] text-sm leading-relaxed mb-4 italic font-light">&ldquo;{t.quote}&rdquo;</p>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#f8d8df] to-[#d5a6b1] flex items-center justify-center text-white text-xs font-bold">{t.name[0]}</div>
                  <span className="text-sm text-[#4a3f44] font-medium">{t.name}</span>
                </div>
                <span className="text-[9px] px-2 py-1 rounded-full bg-green-50 text-green-600 font-bold uppercase tracking-widest border border-green-100">{t.result}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="soft-card p-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              ...
              { value: "€5.80", label: "Avg Daily Meal Cost" },
              { value: "92%", label: "Sleep Improvement" },
      ...
      <section className="max-w-4xl mx-auto px-6 pb-12">
        <div className="soft-card p-8 md:p-12 text-center relative overflow-hidden border-[#d8a7b5]/20">
          <h2 className="text-4xl md:text-5xl mb-4 text-[#4a3f44] tracking-tight leading-tight">
            {t("home.nextChapter")} <br />{t("home.canFeel")} <span className="italic text-[#d8a7b5]">{t("home.amazing")}</span>
          </h2>
          <p className="text-base text-[#7b6870] mb-6 max-w-sm mx-auto font-light leading-relaxed">
            {t("home.beginAssessment")}
          </p>
          <Link href="/quiz" className="btn-primary px-10 py-4 text-lg">{t("home.startAssessment")}</Link>
        </div>
      </section>
