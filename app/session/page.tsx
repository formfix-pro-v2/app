  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-14">
      ...
      <section className="soft-card p-10 text-center mb-8">
        ...
        {!started ? (
          ...
          <div className="space-y-4">
            <div className="text-6xl">{format(timeLeft)}</div>

            <div className="w-24 h-24 rounded-full bg-[#d9a8b8] text-white flex items-center justify-center text-3xl mx-auto animate-pulse">
              ▶
            </div>
          </div>
        )}
      ...
      <section className="soft-card p-8 mb-8">
        <div className="overflow-hidden rounded-3xl mb-6 bg-[#f8f1f4]">
          <img
            src={current.image}
            alt={current.name}
        ...
        <h2 className="text-5xl mb-4">{current.name}</h2>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button onClick={skip} className="btn-outline">
            Skip
          </button>
