...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/blog/pelvic-floor-beginners`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/blog/joint-pain-menopause`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/blog/confidence-posture-midlife`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
