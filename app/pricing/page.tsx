  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="border p-8 rounded-lg flex flex-col items-center text-center">
          <h2 className="text-xl font-semibold mb-6">Basic</h2>
          <PrimaryButton text="Get Started" />
        </div>
        <div className="border p-8 rounded-lg border-blue-500 flex flex-col items-center text-center">
